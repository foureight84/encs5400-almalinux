...
| Check | Result |
|---|---|
| Block devices after cold boot | unchanged — only the two front-bay disks |
| All six AHCI ports rescanned (`echo "- - -" > .../scan`) | nothing |
| PCI device count | 88 before, 88 after |
| SMBIOS slot usage | unchanged |
